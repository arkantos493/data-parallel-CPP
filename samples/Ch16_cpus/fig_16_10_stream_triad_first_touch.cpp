...
double triad(std::vector<double>& vecA, std::vector<double>& vecB,
  ...
  Q.submit([&](handler& h) {
     accessor A{bufA, h, write_only, noinit};
     accessor B{bufB, h, write_only, noinit};
     accessor C{bufC, h, write_only, noinit};
...
int main(int argc, char* argv[]) {
  ...
  std::vector<double> E(array_size);
  std::vector<double> F(array_size);
